...
fun Stmt.tostr (): String {
    return when (this) {
        ...
        is Stmt.SSet   -> "set " + this.dst.tostr() + " = " + this.src.tostr() + "\n"
        is Stmt.ESet   -> "set " + this.dst.tostr() + " = " + this.src.tostr() + "\n"
        is Stmt.Break -> "break\n"
        is Stmt.Ret   -> "return\n"
        is Stmt.Seq   -> this.s1.tostr() + this.s2.tostr()
        is Stmt.SCall -> "call " + this.e.tostr() + "\n"
        is Stmt.Inp   -> "input " + this.lib.str + " " + this.arg.tostr() + ": " + this.xtype!!.tostr() + "\n"
        is Stmt.Out   -> "output " + this.lib.str + " " + this.arg.tostr() + "\n"
